...
onMounted(() => {
    ...
    const el = document.getElementById("openCreateProject")
    if (el !== null) {
...
const props = defineProps(["projects", "customers", "servers", "domains", "repositories", "templates", "randomName"])
