...
return [
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            'js-pages' => ['path' => 'resources/js/Pages', 'generate' => true],
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'NoahWilderom'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Noah Wilderom'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'wilderomnoah@gmail.com'),
        ],
