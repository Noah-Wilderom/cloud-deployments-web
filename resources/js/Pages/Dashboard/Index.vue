        ...
        <div class="container-fixed">
                    ...
                    <div class="lg:col-span-1">
                        <div class="grid grid-cols-2 gap-5 lg:gap-7.5 h-full items-stretch">
                            <div class="card flex-col justify-between gap-6 h-full bg-cover bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
                                <img alt="" class="w-7 mt-4 ms-5" :src="assetPath + '/media/brand-logos/linkedin-2.svg'"/>
            ...
            <span class="text-3xl font-semibold text-gray-900">
             ...
             Amazing mates
                            ...
                            <div class="card flex-col justify-between gap-6 h-full bg-cover bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
                                <img alt="" class="w-7 mt-4 ms-5" :src="assetPath + '/media/brand-logos/youtube-2.svg'"/>
                                <div class="flex flex-col gap-1 pb-4 px-5">
            <span class="text-3xl font-semibold text-gray-900">
             24k
            </span>
             ...
             Lessons Views
                            ...
                            <div class="card flex-col justify-between gap-6 h-full bg-cover bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
                                <img alt="" class="w-7 mt-4 ms-5" :src="assetPath + '/media/brand-logos/instagram-03.svg'"/>
                                <div class="flex flex-col gap-1 pb-4 px-5">
            <span class="text-3xl font-semibold text-gray-900">
             608
            </span>
             ...
             New subscribers
                            ...
                            <div class="card flex-col justify-between gap-6 h-full bg-cover bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
                                <img alt="" class="dark:hidden w-7 mt-4 ms-5" :src="assetPath + '/media/brand-logos/tiktok.svg'"/>
                                <img alt="" class="light:hidden w-7 mt-4 ms-5" :src="assetPath + '/media/brand-logos/tiktok-dark.svg'"/>
                                <div class="flex flex-col gap-1 pb-4 px-5">
            <span class="text-3xl font-semibold text-gray-900">
             2.5k
            </span>
                            ...
                            <div class="card-body p-10 bg-[length:80%] [background-position:175%_25%] bg-no-repeat entry-callout-bg">
                                <div class="flex flex-col justify-center gap-4">
                                    <div class="flex -space-x-2">
                                        <div class="flex">
                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-10" :src="assetPath + '/media/avatars/300-4.png'"/>
                                        </div>
                                        <div class="flex">
                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-10" :src="assetPath + '/media/avatars/300-1.png'"/>
                                        </div>
                                        <div class="flex">
                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-10" :src="assetPath + '/media/avatars/300-2.png'"/>
                                        </div>
                                        <div class="flex">
            ...
            <span class="text-sm font-medium text-gray-600">
             ...
             <span class="text-1.5xl font-semibold text-gray-900">
              ...
              09:00 - 09:30
                                    ...
                                    <img alt="" class="size-7" :src="assetPath + '/media/brand-logos/zoom.svg'"/>
                                </div>
